# Global Task Planning and Documentation Rules v2
...
**Version:** 2.0
**Created:** 2025-12-09
**Based on:** task_planning_rules_v1.md
**Changelog:**
- v2.0 (2025-12-09):
  - Added "⚠️ IMPORTANT!!! Critical Versioning Rules" section at the top
  - Enhanced Workflow 3 with explicit triggers for creating new version
  - Added Anti-pattern "Don't use phases instead of versions"
  - Added versioning rule to start_here.md template
  - Updated Commitments with versioning emphasis
  - Updated Quick Reference with triggers
